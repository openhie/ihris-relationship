...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'filter']) &lt;= 1">extension with URL = 'filter': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'dropDownFilter']) &lt;= 1">extension with URL = 'dropDownFilter': maximum cardinality of 'extension' is 1</sch:assert>
